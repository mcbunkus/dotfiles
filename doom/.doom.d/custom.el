(custom-set-variables
 ...
 '(ledger-reports
   '(("monthly register" "ledger --monthly --real reg")
     ("monthly balance" "ledger bal --real -M")
     ("budget" "ledger bal --budget -p 'this month'")
     ("reg bitcoin" "ledger reg bitcoin")
     ("reg-credit" "ledger reg liabilities:credit")
     ("credit" "ledger reg credit")
     ("reg checking" "ledger reg checking")
